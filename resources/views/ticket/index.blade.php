        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-purple-200 max-w-2xl mx-auto leading-relaxed">
                    Visualize e gerencie todos os tickets do sistema de forma eficiente
                </p>
            </div>
            ...
            <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-blue-500/10 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-6 hover:bg-blue-500/20 transition-all duration-300 cursor-pointer">
                    <div class="flex items-start space-x-4">
                        <div class="flex-shrink-0">
                            <div class="w-10 h-10 bg-blue-500/20 rounded-xl flex items-center justify-center">
                                <svg class="h-6 w-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2-2V7a2 2 0 012-2h2a2 2 0 002 2v2a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 00-2 2v6a2 2 0 01-2 2H9a2 2 0 01-2-2z" />
                                </svg>
                            </div>
                        </div>
                        <div>
                            <h3 class="text-lg font-semibold text-blue-300 mb-2">Exportar Relatório</h3>
                            <p class="text-blue-200 text-sm leading-relaxed">
                                Gere relatórios detalhados dos tickets em formato PDF ou Excel
                            </p>
                        </div>
                    </div>
                </div>

                <div class="bg-purple-500/10 backdrop-blur-sm border border-purple-500/20 rounded-2xl p-6 hover:bg-purple-500/20 transition-all duration-300 cursor-pointer">
                    <div class="flex items-start space-x-4">
                        <div class="flex-shrink-0">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-purple-300 mb-2">Configurações</h3>
                            <p class="text-purple-200 text-sm leading-relaxed">
                                Configure notificações, prioridades e fluxos de trabalho
                            </p>
                        </div>
                    </div>
                </div>

                <div class="bg-green-500/10 backdrop-blur-sm border border-green-500/20 rounded-2xl p-6 hover:bg-green-500/20 transition-all duration-300 cursor-pointer">
                    <div class="flex items-start space-x-4">
                        <div class="flex-shrink-0">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-green-300 mb-2">Ações em Lote</h3>
                            <p class="text-green-200 text-sm leading-relaxed">
                                Execute ações em múltiplos tickets simultaneamente
                            </p>
                        </div>
                    </div>
                </div>
